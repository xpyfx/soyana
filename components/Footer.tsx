...
export const Footer: React.FC = () => {
    return (
        <footer id="contact-footer" className="py-24 px-6 bg-apple-bg mt-auto">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="mt-20 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center text-apple-gray text-sm">
                    <p>&copy; 2025 Anastasia Design. All rights reserved.</p>
